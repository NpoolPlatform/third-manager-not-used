...
const (
	// Label holds the string label denoting the notiftemplate type in the database.
	Label = "notif_template"
...
// Columns holds all SQL columns for notiftemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
